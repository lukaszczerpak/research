...
import eu.czerpak.ejb.SimpleNoInterfaceEJB;
 ...
 */
@WebServlet(urlPatterns = "/SimpleNoInterfaceHessian")
public class SimpleNoInterfaceHessian extends HessianServlet implements SimpleRemote
{
    @EJB
    SimpleNoInterfaceEJB simpleRemote;
